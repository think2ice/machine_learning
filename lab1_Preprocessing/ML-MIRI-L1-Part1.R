...
# LAB 1: Data pre-processing (Part1)
...
# imputation by 1NN: for every individual with a missing 'Income', we look for the most similar individual (according to the remaining variables) and copy its 'Income' value
...
# first we explicitly declare as categorical
...
# Ordered list of continuous variables according to their association to Assessment (more to less)
